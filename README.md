...
***
#### Example 5: A java code to calculate word or character from given input in graphical view

```
import java.awt.event.*;
import javax.swing.*;
public class March extends JFrame implements ActionListener{
	JTextArea ta;
	JButton b1,b2;
	March() { 
...
```
#### Output :
![Word Character Counter-JavaTpoint 2023-01-23 17-21-29](https://user-images.githubusercontent.com/27882232/214027957-bd4211a7-e51d-4c0d-a21f-4366166e4f8d.gif)
